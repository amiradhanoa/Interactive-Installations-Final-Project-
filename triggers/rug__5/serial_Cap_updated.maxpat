...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 286.0, 570.0, 150.0, 23.0 ],
					"style" : "",
					"text_width" : 110.0
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 253.0, 744.0, 150.0, 87.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 693.0, 686.0, 150.0, 33.0 ],
					"style" : "",
					"text" : "simulates constant pressure on the rug"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "int", "int" ],
					"patching_rect" : [ 269.0, 716.0, 50.0, 22.0 ],
					"style" : "",
					"text" : "change"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 565.5, 620.0, 24.0, 24.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 611.0, 686.0, 65.0, 22.0 ],
					"style" : "",
					"text" : "metro 400"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 565.5, 816.0, 24.0, 24.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 635.5, 1002.0, 27.0, 27.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 462.0, 686.0, 59.0, 22.0 ],
					"style" : "",
					"text" : "receive h"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 565.5, 1002.0, 27.0, 27.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 565.5, 885.0, 89.0, 67.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 565.5, 1068.0, 72.0, 22.0 ],
					"style" : "",
					"text" : "send roses"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 635.5, 762.0, 24.0, 24.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 452.0, 503.0, 24.0, 24.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 354.0, 503.0, 24.0, 24.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 249.0, 499.0, 24.0, 24.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 251.5, 439.0, 444.0, 22.0 ],
					"style" : "",
					"text" : "sel 0 1 2 3 94"
				}
...
, 			{
				"box" : 				{
					"angle" : 270.0,
					"bgcolor" : [ 0.522536, 0.894432, 0.814687, 1.0 ],
					"id" : "obj-47",
					"maxclass" : "panel",
					"mode" : 0,
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 445.0, 610.0, 282.0, 494.0 ],
					"proportion" : 0.39,
					"style" : ""
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-3", 0 ],
					"midpoints" : [ 272.5, 423.0, 264.0, 423.0, 264.0, 435.0, 261.0, 435.0 ],
					"source" : [ "obj-11", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 620.5, 747.0, 645.0, 747.0 ],
					"order" : 0,
					"source" : [ "obj-21", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 620.5, 801.0, 575.0, 801.0 ],
					"order" : 1,
					"source" : [ "obj-21", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-34", 0 ],
					"midpoints" : [ 645.0, 801.0, 575.0, 801.0 ],
					"order" : 1,
					"source" : [ "obj-25", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 645.0, 789.0, 645.0, 789.0 ],
					"order" : 0,
					"source" : [ "obj-25", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 575.0, 667.0, 620.5, 667.0 ],
					"source" : [ "obj-28", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 261.0, 495.0, 258.5, 495.0 ],
					"source" : [ "obj-3", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 346.0, 489.0, 363.5, 489.0 ],
					"source" : [ "obj-3", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 431.0, 489.0, 461.5, 489.0 ],
					"source" : [ "obj-3", 2 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-25", 0 ],
					"midpoints" : [ 601.0, 747.0, 645.0, 747.0 ],
					"source" : [ "obj-3", 4 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-25", 0 ],
					"midpoints" : [ 516.0, 672.0, 597.0, 672.0, 597.0, 747.0, 645.0, 747.0 ],
					"source" : [ "obj-3", 3 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 575.0, 843.0, 575.0, 843.0 ],
					"source" : [ "obj-34", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-25", 0 ],
					"midpoints" : [ 673.5, 426.0, 696.0, 426.0, 696.0, 471.0, 687.0, 471.0, 687.0, 747.0, 645.0, 747.0 ],
					"source" : [ "obj-43", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 295.5, 601.0, 454.5, 601.0 ],
					"source" : [ "obj-50", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 575.0, 954.0, 575.0, 954.0 ],
					"source" : [ "obj-70", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 645.0, 954.0, 645.0, 954.0 ],
					"source" : [ "obj-70", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 575.0, 1032.0, 575.0, 1032.0 ],
					"source" : [ "obj-74", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-34", 0 ],
					"midpoints" : [ 471.5, 801.0, 575.0, 801.0 ],
					"source" : [ "obj-75", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-40", 0 ],
					"midpoints" : [ 645.0, 1053.0, 575.0, 1053.0 ],
					"source" : [ "obj-77", 0 ]
				}
